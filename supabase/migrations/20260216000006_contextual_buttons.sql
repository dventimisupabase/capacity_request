-- Migration: Show only relevant buttons based on approval state
-- When commercial has already approved, hide Commercial Approve/Reject.
-- When tech has already approved, hide Tech Approve/Reject.
-- When VP has already approved, hide VP Approve/Reject.
